...
#-------------------------------------------定制化区域----------------------------------------------
-keep public class com.face.baseiotcloud.service.** { *; }
...
-keep class com.face.baseiotcloud.entity.** {*;}
-keep class com.chtj.base_framework.entity.** {*;}
#-------------------------------------------------------------------------

#---------------------------------2.第三方包-------------------------------
### keepalive

-keep class com.chtj.keepalive.entity.** {*;}
### Retrofit
-dontwarn retrofit2.**
